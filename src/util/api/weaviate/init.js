...
const host = 'tipti-s5zfrem9.weaviate.network';
const apiKey = '7hynJC9fTnEBP2ae4UiJ0Ycv2hvxjmFAlYbr';

const client = weaviate.client({
    scheme: 'https',
    host: host,  // Replace with your endpoint
    apiKey: apiKey,  // Replace w/ your Weaviate instance API key
    headers: {
...
async function addSchema() {
    const res = await client.schema.classCreator().withClass(productObj).do();
    console.log(res);
}

async function getJsonData() {
    const file = await fetch('products.json');
    return file.json();
}
